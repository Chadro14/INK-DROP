        ...
        <div className="fixed inset-0 z-50 bg-ink-bg/95 backdrop-blur-sm animate-fade-in">
          <div className="max-w-lg mx-auto px-4 py-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setShowFilters(false)} className="text-ink-muted hover:text-ink-text">
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full mt-1 px-4 py-2 rounded-lg bg-ink-card border border-ink-border text-ink-text focus:border-accent outline-none transition-colors"
              />
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-3 rounded-lg bg-ink-card border border-ink-border text-ink-muted font-semibold hover:text-ink-text transition-colors"
              >
                Réinitialiser
              </button>
            </div>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-6">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-2 rounded-lg bg-ink-card border border-ink-border text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:border-accent transition-colors"
                >
                  Précédent
                </button>
