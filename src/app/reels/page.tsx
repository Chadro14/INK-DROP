...
import { Heart, Bookmark, Share2, Play, Pause, Volume2, VolumeX } from "lucide-react";
...
export default function ReelsPage() {
  ...
  // ============================================
  // SCROLL INFINI (Détection de fin de feed)
  // ============================================
  useEffect(() => {
  ...
  if (reels.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-background text-foreground px-4">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-2">Aucun reel</h1>
          ...
          >
            ...
            <div className="absolute bottom-28 left-4 z-10 max-w-[70%]">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white text-xs font-bold overflow-hidden">
            ...
            <div className="absolute bottom-28 right-4 z-10 flex flex-col items-center gap-5">
              ...
              >
                ...
                <span className="text-white/80 text-xs font-medium">{reel.likesCount}</span>
              </button>
              ...
              >
                ...
                <span className="text-white/80 text-xs font-medium">{reel.commentsCount}</span>
              </button>
...
// ✅ Styles globaux pour cacher la scrollbar
const styles = `
