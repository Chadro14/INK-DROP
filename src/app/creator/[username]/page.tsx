    ...
    <div className="flex flex-col min-h-screen pb-24 bg-zinc-950 text-white selection:bg-blue-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto w-full px-4 md:px-8 -mt-14 md:-mt-20 flex flex-col items-center">
        ...
        <div className="relative mb-3 group">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-zinc-900 overflow-hidden border-4 border-zinc-950 shadow-2xl ring-2 ring-blue-500/40 shrink-0">
            {profile.avatarUrl ? (
              <img 
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          {profile.premiumActive && (
            <span className="px-2.5 py-0.5 rounded-full bg-blue-600 text-white text-[10px] md:text-xs font-black uppercase tracking-wider shadow-sm shadow-blue-500/20">
              PRO
            </span>
          )}
        </div>
        ...
        {activeTab === "stats" && (
          <div className="w-full max-w-xl mx-auto space-y-3">
            <div className="grid grid-cols-3 gap-2.5">
              ...
              <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-4 text-center">
                <Award className="w-5 h-5 mx-auto text-sky-400 mb-1" />
