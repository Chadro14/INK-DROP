...
import { ArrowLeft, BookOpen, Clock, Calendar, User, ChevronRight, Globe, Sparkles } from "lucide-react";
...
export default function ReadPage() {
  ...
  if (error || !manga) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-zinc-950 px-4">
        ...
        <Link href="/discover" className="mt-4 px-6 py-2.5 rounded-full bg-purple-600 text-white font-semibold hover:bg-purple-500 transition-all">
  ...
  return (
    <div className="flex flex-col min-h-screen pb-24 bg-zinc-950 text-white selection:bg-purple-500 selection:text-white">

      <header className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-800/60 px-4 py-3">
        <div className="flex items-center gap-3 max-w-4xl mx-auto">
          <button onClick={() => router.back()} className="text-zinc-400 hover:text-white transition-colors p-2 rounded-full hover:bg-zinc-900">
        ...
        <div>
          ...
          {loadingChapters ? (
            ...
            <div className="text-center text-zinc-500 py-8">
              ...
              <p className="mt-2">Aucun chapitre disponible</p>
            </div>
          ) : (
